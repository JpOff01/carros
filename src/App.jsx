    ...
    <main className="min-h-svh bg-offwhitebg py-20 px-6">
      <section>
        <div className="bg-orange p-12 rounded-t-lg">
          ...
          <a href="https://www.webmotors.com.br/sedans" className="bg-offwhitebg px-10 block py-3 w-fit rounded-3xl text-orange" target="_blank">Ver mais</a>
        </div>
        ...
        <div className="bg-green p-12">
          ...
          <a href="https://www.webmotors.com.br/suvs" className="bg-offwhitebg px-10 block py-3 w-fit rounded-3xl text-green" target="_blank">Ver mais</a>
        </div>
        ...
        <div className="bg-dark-green p-12 rounded-b-lg">
          ...
          <a href="https://www.webmotors.com.br/carros-de-luxo" className="bg-offwhitebg px-10 block py-3 w-fit rounded-3xl text-dark-green" target="_blank">Ver mais</a>
        </div>
      </section>
    </main>
  )
